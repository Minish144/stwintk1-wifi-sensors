 ...
 * Thread v1.1.0 specification; incompatible changes to the specification
...
/* SSL options */
#define MBEDTLS_SSL_MAX_CONTENT_LEN             5500 /**< Maximum fragment length in bytes, determines the size of each of the two internal I/O buffers */
