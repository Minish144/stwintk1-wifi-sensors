...
/* Enabling this define for STWIN will introduce a 10 Seconds delay */
...
#define NAME_STLBLE 'S','T','W','I','N',STLBLE_VERSION_MAJOR,STLBLE_VERSION_MINOR

/* Package Name */
#define STLBLE_PACKAGENAME "STWIN_BLE_SampleApp"
